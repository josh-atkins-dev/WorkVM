...
Vagrant.configure(2) do |config|
  ...
  config.vm.define :dev do |dev|
    ...
    dev.vm.provision "credentials", type: "shell" do |s|
      ...
      s.env = {
        "vagrant_credential_vars" => "AWS_ACCESS_KEY_ID AWS_SECRET_ACCESS_KEY ANSIBLE_CONFIG AWS_DEFAULT_REGION AWS_PREFIX VM_TEMP_PATH ANSIBLE_ROLES_PATH VPC_CIDR VPC_OCTET_1 VPC_OCTET_2 PRIVATE_DNS_NAME AZ1 AZ2 VPN_SUBNET_CIDR EC2_KEY_NAME GITHUB_TOKEN GITHUB_USER ANSIBLE_PRIVATE_KEY_FILE", 
